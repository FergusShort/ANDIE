...
public class EditActions {
    ...
    public EditActions() {
        ...
        actions.add(new UndoAction(bundle.getString("Undo"), null, bundle.getString("Undo") + " (Alt Z)", Integer.valueOf(KeyEvent.VK_Z)));
        actions.add(new RedoAction(bundle.getString("Redo"), null, bundle.getString("Redo") + " (Alt Y)", Integer.valueOf(KeyEvent.VK_Y)));
    }
