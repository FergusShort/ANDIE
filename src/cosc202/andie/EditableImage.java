...
class EditableImage {
    ...
    // private Stack<ImageOperation> png;

    /** The sequences of operations containe din the ops file */
    public static ArrayList<ImageOperation> recorded = new ArrayList<ImageOperation>();
    ...
    /** The file where the edited image is stored */
    ...
    public void saveAs(String imageFilename) throws Exception {
        ...
        // Defult to .png if the user doesn't enter a file type
    ...
    public void export(String imageFilename) throws Exception {
        ...
        this.opsFilename = imageFilename + ".ops";
        if (current == null) {
            throw new IllegalStateException("There's no current edited image");

        }

        // Write image file based on file extension
        String extension = imageFilename.substring(1 +
    ...
    /**
     * <p>
     * Apply the operation contained in an ops file to the image
     * </p>
     * 
     * <p>
     * Apply the operations ot an image with the file provided as a parameter.
     * Deserialise the list of operations saved
     * </p>
     * 
     * @param filePath The file location to export the image to.
     * @throws Exception If something goes wrong.
     */

    public void macroApply(String filepath) {
        try {
            ...
            @SuppressWarnings("unchecked")
            ArrayList<ImageOperation> recorded = (ArrayList<ImageOperation>) objIn.readObject();

            for (ImageOperation a : recorded) {
                apply(a);
            }
    ...
    public void undo() {
        ...
        if (MacroActions.isRecording()) {
            recorded.remove((recorded.size() - 1));
        }
        refresh();
    }
