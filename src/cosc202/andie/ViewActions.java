...
ResourceBundle bundle = LanguagePreferences.getBundle();
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction(bundle.getString("Zoom_In"), null, bundle.getString("Zoom_In")+" (Alt PLUS)", Integer.valueOf(KeyEvent.VK_PLUS)));
        actions.add(new ZoomOutAction(bundle.getString("Zoom_Out"), null, bundle.getString("Zoom_Out")+" (Alt MINUS)", Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(bundle.getString("Zoom_Full"), null, bundle.getString("Zoom_Full")+ " (Alt 1)", Integer.valueOf(KeyEvent.VK_1)));
    }
